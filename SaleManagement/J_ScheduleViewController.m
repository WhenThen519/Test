...
@interface J_ScheduleViewController ()
{
    Fx_TableView *table;
...
@implementation J_ScheduleViewController
#pragma mark - 数据请求
-(void) requestAlldata
{
...
-(void)handleSwipeFrom:(UISwipeGestureRecognizer *)recognizer{
    ...
    if(recognizer.direction==UISwipeGestureRecognizerDirectionDown) {
        ...
        table.frame = CGRectMake(0, IOS7_Height+280, __MainScreen_Width, __MainScreen_Height-280-40-IOS7_Height);
    ...
    if(recognizer.direction==UISwipeGestureRecognizerDirectionUp) {
        ...
        table.frame = CGRectMake(0, IOS7_Height+100, __MainScreen_Width, __MainScreen_Height-100-40-IOS7_Height);
    }
...
- (void)viewDidLoad {
    ...
    //添加列表
    table = [[Fx_TableView alloc] initWithFrame:CGRectMake(0, IOS7_Height+280, __MainScreen_Width, __MainScreen_Height-280-40-IOS7_Height) style:UITableViewStylePlain isNeedRefresh:YES target:self];
    ...
    btn.frame = CGRectMake(0, __MainScreen_Height-40, __MainScreen_Width, 40);
    [self.view addSubview:btn];
    [btn addTarget:self action:@selector(lookSchedule) forControlEvents:UIControlEventTouchUpInside];
    btn.titleLabel.font = [UIFont systemFontOfSize:16];
    [btn setTitleColor:[ToolList getColor:@"666666"] forState:UIControlStateNormal];
    [btn setTitle:@"查看商务日程" forState:UIControlStateNormal];
    
}
#pragma mark - 查看商务日程
-(void)lookSchedule
{
    J_WeekScheduleViewController *week = [[J_WeekScheduleViewController alloc] init];
    week.recevieDate =[dateFormatter3 dateFromString: requestDate];
