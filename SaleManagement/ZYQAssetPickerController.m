...
//    self.title = [NSString stringWithFormat:format, (long)indexPaths.count];
    if (photosSelected)
    {
        NSNumber *b = [[NSUserDefaults standardUserDefaults] objectForKey:@"HaiNengXuan"];
       
        long num =  b.longValue;
        self.title = [NSString stringWithFormat:@"最多6张,还能选%ld张", num-(long)indexPaths.count];
