...
@interface J_WeekScheduleViewController : Fx_RootViewController<JTCalendarDataSource,UITableViewDataSource,UITableViewDelegate>
...
@property (retain, nonatomic)  NSDate *recevieDate;
