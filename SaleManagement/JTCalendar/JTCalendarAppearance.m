...
- (void)setDefaultValues
{
    ...
    self.dayTextColorOtherMonth = [UIColor whiteColor];
    //[UIColor colorWithRed:152./256. green:147./256. blue:157./256. alpha:1.];
    ...
    self.dayCircleColorToday = [UIColor whiteColor];
    self.dayTextColorToday = [ToolList getColor:@"9013FE"];
