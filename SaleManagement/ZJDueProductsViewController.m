...
//
#import "ZJDueProductsTableViewCell.h"
#import "ZJDueProductsViewController.h"
#import "Fx_TableView.h"
#import "UserDetailViewController.h"
@interface ZJDueProductsViewController ()
{
    NSArray *dataArr1;
    //推荐筛选内容
...
@implementation ZJDueProductsViewController
...
-(void) requestAlldata
{
    ...
    [FX_UrlRequestManager postByUrlStr:ZJDueProducts_url andPramas:requestDic andDelegate:self andSuccess:@"requestSuccess:" andFaild:nil andIsNeedCookies:YES];
}
#pragma mark - 页面初始化
-(void)initView
{
...
{
    static NSString *cellID = @"ZJDueProductsTableViewCell";
    ZJDueProductsTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if(cell==nil)
    {
        cell = [[[NSBundle mainBundle] loadNibNamed:@"ZJDueProductsTableViewCell" owner:self options:nil] lastObject];
        //线
