...
+(NSMutableArray*)changeDataArray:(NSArray*)dataArr andStringArr:(NSArray *)stringArr{
...
//         NSString *pinyin = [((ChineseString*)object).pinYin substringToIndex:1];
         ...
         for (int i=0; i<dataArr.count; i++) {
             ...
             if ( [[[dataArr objectAtIndex:i] objectForKey:@"linkManName"]isEqualToString:string]) {
                 
                 [item addObject:[dataArr objectAtIndex:i]];
