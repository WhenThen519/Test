...
@implementation QianKuanViewController
...
-(void) requestAlldata
{
    ...
    [FX_UrlRequestManager postByUrlStr:ArrearCust_url andPramas:requestDic andDelegate:self andSuccess:@"requestSuccess:" andFaild:nil andIsNeedCookies:YES];
}
#pragma mark - 页面初始化
-(void)initView
{
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    QiankuanTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if(cell==nil)
    {
    ...
    NSString *label1 = [NSString stringWithFormat:@"%@ | %@",[ToolList changeNull:[dic objectForKey:@"custVirtualType"]],[ToolList changeNull:[dic objectForKey:@"salerName"]]];
